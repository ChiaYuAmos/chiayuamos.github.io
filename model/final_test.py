...
def extract_features(url):
    try:
        ...
        return {}
# 讀取數據
def mlp_model(learning_rate,epochs,batch_size):
    ...
    model.add(Dense(64, activation='relu', kernel_regularizer=l2(0.04)))
    ...
    # # 訓練模型
    history = model.fit(X_train, y_train, epochs, batch_size, validation_split=0.2, callbacks=[reduce_lr],verbose=1)
...
history = mlp_model(0.00001,10,16)
plt_show(history)
