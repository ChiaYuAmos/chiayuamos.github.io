...
def extract_features(url):
    try:
        ...
        features = {
            ...
            'pct_ext_hyperlinks': 0.0,  # 默认值
            'pct_ext_resource_urls': 0.0,  # 默认值
            'ext_favicon': 0.0,  # 默认值
        }
        try:
        ...
        print(f"Finished processing URL: {url}")  # 调试信息
        return features
